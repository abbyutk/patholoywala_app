...
import 'package:pharmacy/helpers/message_parser.dart';
...
class Notify{
  ...
  final Color _errorColor = StaticColors.error;
  final Color _successColor = StaticColors.success;
  final Color _infoColor = StaticColors.info;
